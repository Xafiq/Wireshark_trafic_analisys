...
- In the filter box at the bottom of the Wireshark window, enter `host [IP-OF-KALI] and http` and press Enter. This will capture all HTTP requests from the Kali machine.
